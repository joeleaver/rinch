//! Rinch Widgets - A UI component library for Rinch.
//!
//! Provides styled, themeable UI components that integrate with the Rinch theme system.
//! Inspired by [Mantine](https://mantine.dev/).
//!
//! This crate implements the `Widget` trait from `rinch-core`, allowing these components
//! to be used seamlessly in RSX macros. Third-party widget libraries can follow the same
//! pattern to create their own widget sets (e.g., `rinch-bootstrap`, `rinch-material`).
//!
...
/// Generate all widget CSS classes.
pub fn generate_widget_css() -> String {
    styles::generate_all_widget_styles()
}
