//! Widget CSS styles.
//!
//! Generates CSS classes for all widgets that integrate with the theme.
//! Each widget has its own style module for maintainability.
...
/// Generate all widget CSS styles.
pub fn generate_all_widget_styles() -> String {
