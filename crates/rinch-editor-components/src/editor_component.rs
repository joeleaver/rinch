//! Main RichTextEditor component configuration.
//!
//! Provides a builder-style API for configuring the editor component.
//! Pure configuration data — rendering is handled by the view layer.

use crate::toolbar::ToolbarConfig;

/// Configuration for the RichTextEditor component.
#[derive(Debug, Clone)]
