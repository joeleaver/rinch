...
fn control_metadata(
    ...
    match control {
        ...
        ToolbarControl::HeadingDropdown => ("¶", "Block type", None),
        ToolbarControl::TextColorPicker => ("A", "Text color", None),
        ...
        ToolbarControl::InsertRowBefore => ("+↑", "Insert row before", None),
        ToolbarControl::InsertRowAfter => ("+↓", "Insert row after", None),
        ToolbarControl::InsertColBefore => ("+←", "Insert column before", None),
        ToolbarControl::InsertColAfter => ("+→", "Insert column after", None),
        ToolbarControl::DeleteRow => ("-↔", "Delete row", None),
        ToolbarControl::DeleteCol => ("-↕", "Delete column", None),
        ToolbarControl::ToggleHeaderRow => ("H", "Toggle header row", None),
        ToolbarControl::MergeCells => ("⊞", "Merge cells", None),
...
fn control_command(control: &ToolbarControl) -> &str {
    match control {
        ...
        ToolbarControl::HeadingDropdown => "setBlockType",
        ToolbarControl::TextColorPicker => "setColor",
        ...
        ToolbarControl::InsertRowBefore => "addRowBefore",
        ToolbarControl::InsertRowAfter => "addRowAfter",
        ToolbarControl::InsertColBefore => "addColumnBefore",
        ToolbarControl::InsertColAfter => "addColumnAfter",
        ToolbarControl::DeleteRow => "deleteRow",
        ToolbarControl::DeleteCol => "deleteColumn",
        ToolbarControl::ToggleHeaderRow => "toggleHeaderRow",
        ToolbarControl::MergeCells => "mergeCells",
        ToolbarControl::SplitCell => "splitCell",
        ToolbarControl::DeleteTable => "deleteTable",
...
fn control_icon(control: &ToolbarControl) -> Option<&str> {
    match control {
        ...
        ToolbarControl::HeadingDropdown => Some("heading"),
        ToolbarControl::TextColorPicker => Some("palette"),
        ...
        ToolbarControl::InsertRowBefore => Some("row-insert-top"),
        ToolbarControl::InsertRowAfter => Some("row-insert-bottom"),
        ToolbarControl::InsertColBefore => Some("column-insert-left"),
        ToolbarControl::InsertColAfter => Some("column-insert-right"),
        ToolbarControl::DeleteRow => Some("row-remove"),
        ToolbarControl::DeleteCol => Some("column-remove"),
        ToolbarControl::ToggleHeaderRow => Some("table-row"),
        ToolbarControl::MergeCells => Some("table-shortcut"),
        ToolbarControl::SplitCell => Some("layout-columns"),
        ToolbarControl::DeleteTable => Some("table-off"),
