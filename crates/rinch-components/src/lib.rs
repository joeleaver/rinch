...
// Allow `::rinch::core::X` paths generated by the rsx! macro to resolve
// inside this crate. `extern crate self as rinch` makes `::rinch` point
// to this crate root, and the `core` module re-exports rinch_core.
