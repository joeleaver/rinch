...
and `perspective(100px) translateZ(10px)` magnifies by 100/90. A list of planar
...
rotateY(30deg)`, a trapezoid) loses its `m14`/`m24`; and a mismatched remainder
with a 3D function in it is decomposed flat (#989).
